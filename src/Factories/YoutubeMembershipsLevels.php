...
class YoutubeMembershipsLevels
{
    /**
    ...
    /**
     * @param array<int, array<string, mixed>> $membershipsLevels
     * @throws JsonException
     */
    public static function listWithMembershipsLevels(array $membershipsLevels): FakeResponse
    {
        $items = array_map(fn(array $level) => self::buildMembershipsLevel($level), $membershipsLevels);
     ...
     * @throws JsonException
     */
    public static function membershipsLevel(array $overrides = []): array
    {
        return self::buildMembershipsLevel($overrides);
    }
     ...
     * @throws JsonException
     */
    private static function buildMembershipsLevel(array $overrides = []): array
    {
        $fixture = self::loadFixture();
    ...
    private static function loadFixture(): array
    {
        ...
        if ($fixture === null) {
            $path = dirname(__DIR__) . '/Fixtures/youtube/memberships-levels-list.json';
