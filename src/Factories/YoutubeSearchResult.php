...
class YoutubeSearchResult
{
     ...
     * @throws JsonException
     */
    public static function listWithResults(array $results): FakeResponse
    {
        $items = array_map(fn (array $result) => self::buildSearchResult($result), $results);
    ...
    {
        return self::buildSearchResult($overrides);
    }
     ...
     * @throws JsonException
     */
    private static function buildSearchResult(array $overrides = []): array
    {
        $fixture = self::loadFixture();
    ...
    private static function loadFixture(): array
    {
        ...
        if ($fixture === null) {
            $path = dirname(__DIR__) . '/Fixtures/youtube/search-list.json';
