...
class YoutubeVideoAbuseReportReasons
{
    /**
     ...
     * @throws JsonException
     */
    public static function listWithReasons(array $reasons): FakeResponse
    {
        $items = array_map(fn(array $reason) => self::buildReason($reason), $reasons);
     ...
     * @throws JsonException
     */
    public static function reason(array $overrides = []): array
    {
        return self::buildReason($overrides);
    }
     ...
     * @throws JsonException
     */
    private static function buildReason(array $overrides = []): array
    {
        $fixture = self::loadFixture();
    ...
    private static function loadFixture(): array
    {
        ...
        if ($fixture === null) {
            $path = dirname(__DIR__) . '/Fixtures/youtube/video-abuse-report-reasons-list.json';
