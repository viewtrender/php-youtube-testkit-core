...
class YoutubeChannel
{
     ...
     * @throws JsonException
     */
    public static function listWithChannels(array $channels): FakeResponse
    {
        $items = array_map(fn(array $channel) => self::buildChannel($channel), $channels);
    ...
    {
        return self::buildChannel($overrides);
    }
     ...
     * @throws JsonException
     */
    private static function buildChannel(array $overrides = []): array
    {
        $fixture = self::loadFixture();
    ...
    private static function loadFixture(): array
    {
        ...
        if ($fixture === null) {
            $path = dirname(__DIR__) . '/Fixtures/youtube/channels-list.json';
