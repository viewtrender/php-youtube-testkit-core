...
class YoutubeChannelSections
{
    ...
    /**
     * @param array<int, array<string, mixed>> $channelSections
     * @throws JsonException
     */
    public static function listWithChannelSections(array $channelSections): FakeResponse
    {
        $items = array_map(fn(array $section) => self::buildChannelSection($section), $channelSections);
     ...
     * @throws JsonException
     */
    public static function channelSection(array $overrides = []): array
    {
        return self::buildChannelSection($overrides);
    }
     ...
     * @throws JsonException
     */
    private static function buildChannelSection(array $overrides = []): array
    {
        $fixture = self::loadFixture();
    ...
    private static function loadFixture(): array
    {
        ...
        if ($fixture === null) {
            $path = dirname(__DIR__) . '/Fixtures/youtube/channel-sections-list.json';
