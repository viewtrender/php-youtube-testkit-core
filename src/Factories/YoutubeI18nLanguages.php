...
class YoutubeI18nLanguages
{
     ...
     * @throws JsonException
     */
    public static function listWithLanguages(array $languages): FakeResponse
    {
        $items = array_map(fn(array $language) => self::buildLanguage($language), $languages);
     ...
     * @throws JsonException
     */
    public static function language(array $overrides = []): array
    {
        return self::buildLanguage($overrides);
    }
     ...
     * @throws JsonException
     */
    private static function buildLanguage(array $overrides = []): array
    {
        $fixture = self::loadFixture();
    ...
    private static function loadFixture(): array
    {
        ...
        if ($fixture === null) {
            $path = dirname(__DIR__) . '/Fixtures/youtube/i18n-languages-list.json';
