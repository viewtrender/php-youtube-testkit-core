...
class ReportingReport
{
     ...
     * @throws JsonException
     */
    public static function listWithReports(array $reports): FakeResponse
    {
        $fixture = self::loadFixture();
     ...
     * @throws JsonException
     */
    public static function report(array $overrides = []): array
    {
        $fixture = self::loadFixture();
        $base = $fixture['reports'][0];
    ...
    private static function loadFixture(): array
    {
        ...
        if ($fixture === null) {
            $path = dirname(__DIR__) . '/Fixtures/reporting/reports-list.json';
