...
class YoutubeSubscriptions
{
     ...
     * @throws JsonException
     */
    public static function listWithSubscriptions(array $subscriptions): FakeResponse
    {
        $items = array_map(fn(array $subscription) => self::buildSubscription($subscription), $subscriptions);
    ...
    {
        return self::buildSubscription($overrides);
    }
     ...
     * @throws JsonException
     */
    private static function buildSubscription(array $overrides = []): array
    {
        $fixture = self::loadFixture();
    ...
    private static function loadFixture(): array
    {
        ...
        if ($fixture === null) {
            $path = dirname(__DIR__) . '/Fixtures/youtube/subscriptions-list.json';
