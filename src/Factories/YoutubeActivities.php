...
class YoutubeActivities
{
     ...
     * @throws JsonException
     */
    public static function listWithActivities(array $activities): FakeResponse
    {
        $items = array_map(fn(array $activity) => self::buildActivity($activity), $activities);
     ...
     * @throws JsonException
     */
    public static function activity(array $overrides = []): array
    {
     ...
     * @throws JsonException
     */
    private static function buildActivity(array $overrides = []): array
    {
        $fixture = self::loadFixture();
    ...
    private static function loadFixture(): array
    {
        ...
        if ($fixture === null) {
            $path = dirname(__DIR__) . '/Fixtures/youtube/activities-list.json';
