...
class YoutubeComments
{
     ...
     * @throws JsonException
     */
    public static function listWithComments(array $comments): FakeResponse
    {
        $items = array_map(fn(array $comment) => self::buildComment($comment), $comments);
     ...
     * @throws JsonException
     */
    public static function comment(array $overrides = []): array
    {
     ...
     * @throws JsonException
     */
    private static function buildComment(array $overrides = []): array
    {
        $fixture = self::loadFixture();
    ...
    private static function loadFixture(): array
    {
        ...
        if ($fixture === null) {
            $path = dirname(__DIR__) . '/Fixtures/youtube/comments-list.json';
