...
class YoutubePlaylist
{
     ...
     * @throws JsonException
     */
    public static function listWithPlaylists(array $playlists): FakeResponse
    {
        $items = array_map(fn (array $playlist) => self::buildPlaylist($playlist), $playlists);
     ...
     * @throws JsonException
     */
    public static function playlist(array $overrides = []): array
    {
        return self::buildPlaylist($overrides);
    }
     ...
     * @throws JsonException
     */
    private static function buildPlaylist(array $overrides = []): array
    {
        $fixture = self::loadFixture();
    ...
    private static function loadFixture(): array
    {
        ...
        if ($fixture === null) {
            $path = dirname(__DIR__) . '/Fixtures/youtube/playlists-list.json';
